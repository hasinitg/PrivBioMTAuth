 ...
 */
public class JSONIdentityTokenEncoderDecoder implements IdentityTokenEncoderDecoder {
    @Override
    public JSONObject encodeIdentityToken(IdentityToken identityToken) throws Exception {
        ...
        IDTContent.put(Constants.TO_IDENTITY, identityToken.getToIdentity());
    ...
    public IdentityToken decodeIdentityToken(String identityTokenStrRepresentation) throws Exception {
        ...
        identityToken.setToIdentity(jsonIDT.optString(Constants.TO_IDENTITY));
